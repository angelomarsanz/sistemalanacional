...
class BudgetsController extends AppController
{
    ...
    {   
		...
		$services = $this->Services->find('list', ['limit' => 1000, 'conditions' => [['Services.registration_status' => 'ACTIVO'], ['OR' => [['Services.cost_bolivars >' => 0], ['Services.cost_dollars >' => 0], ['Services.id' => 107]]]], 'order' => ['Services.service_description' => 'ASC']]);
