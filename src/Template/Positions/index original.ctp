    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('type_of_salary') ?></th>
                <th scope="col"><?= $this->Paginator->sort('minimum_wage') ?></th>
                <th scope="col"><?= $this->Paginator->sort('reason_salary_increase') ?></th>
                <th scope="col"><?= $this->Paginator->sort('effective_date_increase') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($position->record_deleted) ?></td>
