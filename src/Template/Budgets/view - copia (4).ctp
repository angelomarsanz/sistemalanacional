    ...
    <div class="row">
        <div class="col col-sm-12">
			...
			<?php else: ?>
				...
				<?php if ($pos): ?>
					<?php echo $this->Html->link(__(''), '../files/budgets/initial_budget/' . $budget->initial_budget_dir . '/'. $budget->initial_budget, ['class' => 'glyphicon glyphicon-search', 'title' => 'Ver presupuesto', 'target' => '_blank']); ?>
				<?php else: ?>    
					<?php $txt = ".txt"; ?>  
