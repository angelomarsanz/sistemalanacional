...
<div class="container">
    ...
    <div id="menu-mas-budget" style="display:none;" class="menumas">
		...
		<?= $this->Html->link(__(''), ['controller' => 'Diarypatients', 'action' => 'reportDiary'], ['id' => 'report-diary', 'class' => 'glyphicon glyphicon-th-list btn btn-danger', 'title' => 'Reporte de presupuestos']) ?>
