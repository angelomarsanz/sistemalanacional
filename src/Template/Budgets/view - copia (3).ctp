        ...
        <div class="col col-sm-12">
			...
			<?php else: ?>
				...
				<?php else: ?>    
					...
					<?php if ($pos): ?>
						<?php $texto = file_get_contents('http://localhost/sln/webroot/files/budgets/initial_budget/' . $budget->initial_budget_dir . '/'. $budget->initial_budget); ?> 
						<?php $texto = nl2br($texto); ?>
						<?php echo $texto; ?>
					<?php else: ?>
