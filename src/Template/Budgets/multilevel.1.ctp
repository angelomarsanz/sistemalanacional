		...
		<?php if (isset($budgetsG)): ?>
			    ...
			    <div class="col-md-6">
				   	<div id="pacientes-atendidos" style="margin-left: 10px; display:none;">
						...
						<div class="table-responsive" style="margin-left: 10px;">
				            ...
				            <p style="margin-left: 10px;"><b><?php echo 'Comisiones por ventas propias (10%): Bs. ' . number_format(($comisionPadre * 0.1), 2, ",", "."); ?></b></p>
						</div> 
					</div>
				</div>
			</div>
				        ...
				        <?php foreach ($children as $childrens): ?>
				        	<?php if ($rolePromoter != 'Coordinador(a)'): ?>
								...
								<div class="table-responsive" style="margin-left: 20px;">
			                        ...
			                        <p style="margin-left: 10px;"><b><?php echo 'Comisiones por ventas realizadas por los hijos (5%): Bs. ' . number_format(($comisionHijos * 0.05), 2, ",", ".") ?></b></p>
								</div> 
						    <?php endif; ?>
				        <?php endforeach; ?>
				        <?php if ($swChildren == 0): ?>
			...
			<div class="row">
			    <div class="col-md-6">
			            ...
			            <p style="margin-left: 20px;"><b><?php echo 'Comisiones por ventas realizadas por los nietos (3%): Bs. ' . number_format(($comisionNietos * 0.03), 2, ",", "."); ?></b></p>
				    </div>
			    </div>
			</div>
