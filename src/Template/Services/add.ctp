            ...
            <fieldset>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input  id='national-dollar-cost' name='service_code' style='text-align: right;' class='alternative-decimal-separator form-control' step='any' value=<?= number_format(0, 2, ",", ".") ?>>
                        <br />						
