...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #00ffcc;">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href='/users/home'><img src='/img/logo.png' width = 100 height = 35 class="img-thumbnail img-responsive logo"/></a>
            ...
            <?php if(isset($current_user)): ?>
                <ul class="nav navbar-nav">
                    ...
                    <?php if($current_user['role'] == 'Desarrollador del sistema'): ?>
                        ...
                        <li><?=  $this->Html->link('Presupuestos', ['controller' => 'Services', 'action' => 'index']) ?></li>
                        ...
                        <?php if (isset($currentView)): ?>    
                            ...
                            <?php endif; ?>
                            <?php if ($currentView == 'usersViewGlobal' || $currentView == 'usersIndexPatient'): ?>
                                <form class="navbar-form navbar-left" role="search">
                                    <div class="form-group">
