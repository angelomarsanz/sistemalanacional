...
class PatienthistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'patient_id' => ['type' => 'index', 'columns' => ['budget_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'patienthistories_ibfk_1' => ['type' => 'foreign', 'columns' => ['budget_id'], 'references' => ['budgets', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'deleted_record' => 1,
            'created' => '2017-08-05 13:52:37',
            'modified' => '2017-08-05 13:52:37'
        ],
    ];
}
